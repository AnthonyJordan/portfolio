const config = {
  ...
  projects: [
    ...
    },
    {
      ...
      brief:
        "A gallery I built to display a clients art and to integrate with their prexisting website and hosting setup.",
      description:
    ...
    },
    {
      ...
      brief:
        "A website I built to display members of guilds in the popular MMORPG Final Fantasy 14. Allows users to create accounts, upload images, build profiles for their characters, add comments, and more.",
      description:
